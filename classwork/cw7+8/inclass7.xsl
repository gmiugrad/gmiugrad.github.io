...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="filepath" select="'/Users/Grayson Murphy/Desktop/'"/>
    ...
    It also creates elements in 3 namespaces:
            1. xmlns="http://www.idpf.org/2007/opf"
            2. xmlns:dc="http://purl.org/dc/elements/1.1/"
            3. xmlns="http://www.daisy.org/z3986/2005/ncx/" version="2005-1"                                                     -->
    ...
    <!-- The following _ 6 metadata___ templates are affecting the resulting opf file. -->
    <!-- This type of template is common in XSLT because it keeps _contents of TEI header ___ while removing _the container elements___. -->
    ...
    <!-- Lots of templates creating _individual .xhtml files______ from the source document. -->
    ...
    <!-- Among the below templates I add a couple classes: _right____ and _footnotes_____, so I need to remember to treat them in the CSS.-->
